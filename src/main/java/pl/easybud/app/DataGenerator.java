...
//			createOrders(orderRepository);
	...
	private void createUsers(UserRepository userRepository, PasswordEncoder passwordEncoder) {
		manager = new User("kierownik@easybud.pl", "Stanisław Anioł", passwordEncoder.encode("kierownik"), Role.MANAGER);
		manager.setLocked(false);
		userRepository.save(manager);

		employee = new User("pracownik@easybud.pl", "Józef Balcerek", passwordEncoder.encode("pracownik"), Role.EMPLOYEE);
		employee.setLocked(false);
		userRepository.save(employee);

		admin = new User("admin@easybud.pl", "Krzysztof Jarzyna", passwordEncoder.encode("admin"), Role.ADMIN);
...
//	private void createUsers(UserRepository userRepository, PasswordEncoder passwordEncoder) {
//
//		User user = new User("kierownik@easybud.pl", "Stanisław Anioł", passwordEncoder.encode("kierownik"), Role.MANAGER);
//		user.setLocked(false);
//		manager = userRepository.save(user);
//
//		user = new User("pracownik@easybud.pl", "Józef Balcerek", passwordEncoder.encode("pracownik"), Role.EMPLOYEE);
//		user.setLocked(false);
//		employee = userRepository.save(user);
//
//		user = new User("admin@easybud.pl", "Krzysztof Jarzyna", passwordEncoder.encode("admin"), Role.ADMIN);
//		user.setLocked(true);
