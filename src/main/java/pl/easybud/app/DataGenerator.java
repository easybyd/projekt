...
import pl.easybud.backend.UserRepository;
...
import pl.easybud.backend.data.entity.OrderItem;
...
public class DataGenerator implements HasLogger {
	...
	private void createUsers(UserRepository userRepository, PasswordEncoder passwordEncoder) {
		baker = userRepository.save(new User("baker@vaadin.com", "Heidi", passwordEncoder.encode("baker"), Role.MANAGER));
		User user = new User("barista@vaadin.com", "Malin", passwordEncoder.encode("barista"), Role.EMPLOYEE);
		user.setLocked(true);
